...
@Composable
fun CheckItem(
    ingredient: GroceriesIngredient,
    onCheckedChange: (GroceriesIngredient) -> Unit,
) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
...
private fun CheckItemPreview() {
    Column(modifier = Modifier.padding(8.dp)) {
        CheckItem(
            ingredient = GroceriesPreviewHelper().createGroceriesIngredient(isCrossedOut = true),
            onCheckedChange = {}
        )
        CheckItem(
            ingredient = GroceriesPreviewHelper().createGroceriesIngredient(),
            onCheckedChange = {}
        )
        CheckItem(
            ingredient = GroceriesPreviewHelper().createGroceriesIngredient(name = "Spinach Coconut milk (full-fat) Coconut milk (full-fat)"),
            onCheckedChange = {}
        )
    }
}